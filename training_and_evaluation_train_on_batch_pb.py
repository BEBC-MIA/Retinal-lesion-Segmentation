...
if __name__ == '__main__':
    ...
    paraser.add_argument('--test_path', type=str, default='IDRiD/val/4 classes/image_zoom_hd', help='path of testing set')
    ...
    paraser.add_argument('--load_dir_initial', type=str, default='IDRiD/result/4 classes/IDRiD_1376_bs_1_reswunet++_gn_adamw_4classes_pb_aug20_EX60_HE0_MA100_SE0_test1/idrid_lesion_initial.hdf5',
