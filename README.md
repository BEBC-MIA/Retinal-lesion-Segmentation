...
## 1. Prepare data 
- The DR datasets we collated from [IDRiD dataset](https://doi.org/10.3390/data3030025) and [e-ophtha dataset](https://doi.org/10.1016/j.media.2014.05.004). You can download the datasets.zip from [Baidu Netdisk](https://pan.baidu.com/s/1hVhhMA8vT3sfFXyPytTQ3Q?pwd=qv19&_at_=1711631389020) and decompress it to ["./original_data"](original_data). The more details are in the directory of ["./original_data/README.md"](original_data/README.md).
